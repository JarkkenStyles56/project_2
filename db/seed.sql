...
INSERT INTO posts (title, body, rating, image, userId)
VALUES ("Is the cake a lie?", "You're darn tootin it is? Why? Because I read it on the internet that's why", 4, "No image found", 1),
 ...
 And the agents are simply unaware of what sudoku is, and therefore think that they must be some sort of code or message. Really, it's just a game.",5,"No Image found", 1 ),
 ("af;oijffa;efnaoijfjfads", "af;ofw;ofnfenwafonowefiowefj wefaweafijo wefijo  weijo wef aijo sfd ijo sfd ijo fda ijo sfdijo efijo ef", 1, "No image found", 2),
 ("Uno, Dos, Tres, Quatro!", "MR. WORLDWIDE! DALE! DALE! 3-0-5! Take a picture of me with a Kodak!",5, "No image found", 3);
